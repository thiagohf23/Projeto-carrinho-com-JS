...
function atualizarCarrinho() {
    let carrinhoHTML = document.getElementById('produtos-dinamicos');
    carrinhoHTML.innerHTML = ''; // Limpa o carrinho antes de adicionar os itens
...
function atualizarNumerosTela(item) {
    let produto = carrinho[item];
    let qtd = document.getElementById('quantidade' + item);
    qtd.innerHTML = produto.quantidade;
...
// Inicia a função start quando o script é carregado
